  ...
  <div class="grid">
    ...
    <div class="col-12 lg:col-6">
      <div class="card">
        ...
        <Button label="Messages" icon="pi pi-users" class="p-button-warning" badge="8" badge-class="p-badge-danger"></Button>
      ...
      <div class="card">
        ...
        <h5>Icon - Badge</h5>
        <Avatar v-badge.success="4" icon="pi pi-user" class="mr-2" size="xlarge"></Avatar>
      </div>
      ...
      <div class="card">
        ...
        <ScrollPanel :style="{ width: '250px', height: '200px' }">
          <p>
            ...
            feugiat nibh sed pulvinar proin gravida hendrerit lectus a. Tincidunt arcu non sodales neque sodales. Metus aliquam eleifend mi in nulla posuere sollicitudin aliquam ultrices. Sodales ut etiam sit amet nisl purus. Cursus sit amet dictum
            sit amet. Tristique senectus et netus et malesuada fames ac turpis egestas. Et tortor consequat id porta nibh venenatis cras sed. Diam maecenas ultricies mi eget mauris. Eget egestas purus viverra accumsan in nisl nisi. Suscipit
