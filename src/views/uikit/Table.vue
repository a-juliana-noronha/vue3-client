        ...
        >
          ...
          <Column header="Country" filter-field="country.name" style="min-width: 12rem">
            ...
            <template #filterclear="{ filterCallback }">
              <Button type="button" icon="pi pi-times" severity="secondary" @click="filterCallback()"></Button>
            </template>
            <template #filterapply="{ filterCallback }">
              <Button type="button" icon="pi pi-check" severity="success" @click="filterCallback()"></Button>
            </template>
          </Column>
          ...
          <Column field="activity" header="Activity" :show-filter-match-modes="false" style="min-width: 12rem">
            <template #body="{ data }">
              <ProgressBar :value="data.activity" :show-value="false" style="height: 0.5rem"></ProgressBar>
            </template>
            <template #filter="{ filterModel }">
    ...
    <div class="col-12">
      <div class="card">
        ...
        <DataTable :value="customer2" :scrollable="true" scroll-height="400px" :loading="loading2" scroll-direction="both" class="mt-3">
          ...
          <Column field="balance" header="Balance" style="min-width: 200px" frozen align-frozen="right">
            <template #body="{ data }">
