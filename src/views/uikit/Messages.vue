...
<template>
  <div class="grid">
    <div class="col-12 lg:col-6">
      <div class="card">
        <h5>Toast</h5>
        <Button label="Success" class="mr-2" severity="success" @click="showSuccess()" />
        <Button label="Info" class="mr-2" severity="info" @click="showInfo()" />
        <Button label="Warn" class="mr-2" severity="warning" @click="showWarn()" />
        <Button label="Error" class="mr-2" severity="danger" @click="showError()" />
      </div>
    </div>
    ...
    <div class="col-12 lg:col-6">
      <div class="card">
        <h5>Messages</h5>
        <Button label="Success" class="mr-2" severity="success" @click="addMessage('success')" />
        <Button label="Info" class="mr-2" severity="info" @click="addMessage('info')" />
        <Button label="Warn" class="mr-2" severity="warning" @click="addMessage('warn')" />
        <Button label="Error" class="mr-2" severity="danger" @click="addMessage('error')" />
