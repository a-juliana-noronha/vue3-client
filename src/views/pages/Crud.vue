        ...
        <Toolbar class="mb-4">
          <template #start>
            <div class="my-2">
              ...
              <Button label="Delete" icon="pi pi-trash" severity="danger" :disabled="!selectedProducts || !selectedProducts.length" @click="confirmDeleteSelected" />
            </div>
          </template>
        ...
        >
          <template #header>
            <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
              ...
              <IconField icon-position="left" class="block mt-2 md:mt-0">
                <InputIcon class="pi pi-search" />
                <InputText v-model="filters['global'].value" class="w-full sm:w-auto" placeholder="Search..." />
              </IconField>
            </div>
          </template>
