...
<template>
  <div>
    ...
    <BlockViewer header="Banner" :code="block5" container-class="surface-section py-8" free>
    ...
    <BlockViewer header="Sign-In" :code="block8" container-class="surface-ground px-4 py-8 md:px-6 lg:px-8 flex align-items-center justify-content-center" free>
    ...
    <BlockViewer header="Description List" :code="block9" container-class="surface-section px-4 py-8 md:px-6 lg:px-8" free>
    ...
    <BlockViewer header="Card" :code="block10" container-class="px-4 py-8 md:px-6 lg:px-8" free>
